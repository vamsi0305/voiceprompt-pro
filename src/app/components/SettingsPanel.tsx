...
export default function SettingsPanel({
    ...
    return (
        <>
            ...
            />
            <div
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[480px] max-w-[95vw] max-h-[85vh] glass-card rounded-2xl flex flex-col overflow-hidden"
